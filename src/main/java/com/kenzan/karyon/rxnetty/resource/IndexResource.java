            ...
            public Observable<Void> handle(HttpServerRequest<ByteBuf> request,
                ...
                .flatMap(new Func1<String, Observable<Void>>() {
                    ...
                    public Observable<Void> call(String body) {
                        ...
                        response.writeString("<html><head><style>body{text-align:center;font-family:'Lucida Grande'}</style></head><body><a href='http://www.altoros.com/' target='_blank'><img src='http://www.sophiaconsultores.com.ar/wp-content/uploads/2016/02/Sin-t%C3%83%C2%ADtulo-1.png'/></a><h2>Example Spinnaker Application</h2><h3>Instance Id " + instanceId + "</h3></body></html>");
